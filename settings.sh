...
:<< "NOTE"
1. dolphin 不能加：无法启动。
2. kdeconnect 不能加：无法启动。
3. PipeWire 不适合加入：可能与 PulseAudio 冲突；且需要后台常驻运行，但 Conty 环境无法启动 systemd/系统服务。
4. EasyEffects / lsp-plugins 会生成大量无用桌面图标，导致 nwg-drawer 里出现一堆杂项图标。
NOTE

# Packages to install
# You can add packages that you want and remove packages that you don't need
# Apart from packages from the official Arch repos, you can also specify
# packages from the Chaotic-AUR and Arch Linux CN repos
PACKAGES=(
	# general environment
	# hdspmixer 需要 FLTK 库（libfltk.so.1.3）才能显示 GUI
	boost-libs fltk fltk1.3
	# cli_download_tools
	curl wget aria2 rsync
	# udisks2_tools
	udiskie udisks2 udisks2-btrfs udisks2-lvm2
	# terminal_emulators
	...
	file-roller ark
	# qt_dependencies
	qt5ct qt5-base qt5-wayland qt5-tools qt5-declarative qt5-multimedia qt5-x11extras qt5-graphicaleffects qt5-imageformats qt5-quickcontrols
	...
	rime-stroke rime-terra-pinyin rime-wubi rime-wugniu rime-wanxiang-pinyin
	...
	# multimedia_tools
	mpv ffmpeg audacity feh nsxiv imagemagick gpicview v4l-utils gst-plugins-espeak
	gstreamer gst-plugins-base gst-plugins-base-libs gst-plugins-good gst-plugins-bad gst-plugins-bad-libs gst-plugins-ugly gst-libav
	# file_manager_tools
	...
	# python_dev_tools
	python python-pip python-setuptools python-wheel python-virtualenv ipython cython
	...
	# gtk_packages
	gtk3 gtk4 webkit2gtk-4.1 glib2
	...
	dconf dconf-editor hplip meld psensor speedcrunch qalculate-gtk kcolorchooser bleachbit peek shutter filezilla
	# video_acceleration
	...
	nm-cloud-setup networkmanager-qt networkmanager-strongswan networkmanager-vpnc nm-connection-editor
	# multimedia_libs
	...
	# pulseaudio_packages
	pulseaudio pulseaudio-alsa pulseaudio-bluetooth pulseaudio-equalizer pavucontrol pamixer pasystray libpulse
	...
	# remote_utilities
	freerdp spice spice-vdagent spice-protocol spice-gtk libvncserver x11vnc wayvnc gtk-vnc kwallet5 libsecret virt-viewer
